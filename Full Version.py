...
def builder():
    ...
    loop = True
    while loop:
        newpass = input('Please enter your Adventurer Code: ')
    ...
    print("""
            ...
            """)
    print('-----------------------')
    print("""Heres an explanation on skills,
Each race has there own unique skills which can help you in battle, when you
select a race it will tell you what the skill does and how many uses it has,
once you run out uses and try to use a skill you will just stand still.""")
    print('-----------------------')
    while loop:
        ...
        if user_race == 'g' or user_race == 'goose':
            print('''
                ...
                ''')
            select = input('Would you like to play as the goose?[y]es or [n]: ').lower()
            ...
            print('''
                    ...
                    ''')
            select = input('Would you like to play as the human?[y]es or [n]: ').lower()
            if select == 'yes' or select == 'y':
                skillcount = 1
                race_skill = skillcount
                loop = False
            ...
            print("""
                    ...
                    """)
            select = input('Would you like to play as the orc?[y]es or [n]: ').lower()
            if select == 'yes' or select == 'y':
                skillcount = 3
                race_skill = skillcount
                loop = False
            ...
            print("""
                    ...
                    """)
            select = input('Would you like to play as the elf?[y]es or [n]: ').lower()
            if select == 'yes' or select == 'y':
                skillcount = 2
                race_skill = skillcount
                loop = False
            ...
            print("""
                    ...
                    Dragons Breath lets you do double the usual amount of magic
                    damage. uses:1
                    """)
            select = input('Would you like to play as the Dragonkin?[y]es or [n]: ').lower()
            if select == 'yes' or select == 'y':
                skillcount = 1
                race_skill = skillcount
                loop = False
    ...
    while playerhp > 0 and chair > 0:
        ...
        if move == "a" or move == "attack":
            ...
            if stunchance == 1:
                ...
                chair = chair - playerattack
                print('you attack the Chair Mimic and stun it dealing', playerattack, 'damage, Chair Mimic hp', chair)
        elif move == 'b':
            deflectchance = random.randint(1,2)
            if deflectchance == 1:
                chair = chair - playerattack
                print('you deflect the attack, you deal', playerattack, 'to the Chair Mimic health', chair)
            elif deflectchance == 2:
                playerhp = playerhp - chairattack
...
You look down and an eye opens... You jump back in panic and a massive Ancient Gold Dragon rises from the pile.''')
    ...
    while playerhp > 0 and dragon > 0:
        playerattack = random.randint(8,13)
        playermagic = random.randint(3,12)
